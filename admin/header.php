    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" class="shadow-sm">
            ...
            <div class="list-group list-group-flush mt-3">
                ...
                <a href="prediksi.php" class="list-group-item list-group-item-action">
                    <i class="fa fa-chart-bar fa-fw mr-2"></i> <span class="menu-text">Prediksi</span>
                </a>
                <a href="user.php" class="list-group-item list-group-item-action">
                    <i class="fa fa-users fa-fw mr-2"></i> <span class="menu-text">User</span>
                </a>
